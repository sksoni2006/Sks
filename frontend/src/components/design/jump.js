...
export const DragCards = () => {
  return (
    <section className="relative grid h-[100%] mx-2 w-full place-content-center overflow-hidden rounded-3xl bg-neutral-950">
      <h2 className="relative z-0 text-[20vw] font-black text-neutral-800 md:text-[200px]">
        Technothlon<span className="text-indigo-500">.</span>
      </h2>
      <Cards />
    </section>
  );
